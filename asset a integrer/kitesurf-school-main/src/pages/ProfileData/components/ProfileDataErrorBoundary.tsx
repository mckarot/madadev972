// src/pages/ProfileData/components/ProfileDataErrorBoundary.tsx

import { Component, ErrorInfo, ReactNode } from 'react';

interface ProfileDataErrorBoundaryProps {
  children: ReactNode;
  fallback?: ReactNode;
}

interface ProfileDataErrorBoundaryState {
  hasError: boolean;
  error: Error | null;
  isDatabaseError: boolean;
}

export class ProfileDataErrorBoundary extends Component<
  ProfileDataErrorBoundaryProps,
  ProfileDataErrorBoundaryState
> {
  constructor(props: ProfileDataErrorBoundaryProps) {
    super(props);
    this.state = { hasError: false, error: null, isDatabaseError: false };
  }

  static getDerivedStateFromError(error: Error): ProfileDataErrorBoundaryState {
  ...
  componentDidCatch(error: Error, errorInfo: ErrorInfo): void {
    console.error('ProfileDataErrorBoundary caught an error:', error, errorInfo);
  }
