    ...
    <section className="relative w-full h-screen bg-bg-base flex items-center justify-center overflow-hidden px-12 lg:px-24">
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: 0.5 }} className="z-20 relative pointer-events-none text-text-main">
          ...
          <p className="text-text-muted text-lg max-w-md mb-8 leading-relaxed text-text-main">Nous créons des expériences numériques immersives où la technologie rencontre l'art. Notre assistant veillera sur vous avec bienveillance tout au long de votre voyage au cœur de notre univers.</p>
        </motion.div>
