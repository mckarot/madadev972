...
export const ServiceCard = memo(({ title, description, delay, accentColor = "blue", href = "#" }: ServiceCardProps) => (
...
export const SectionHeading = memo(({ children, subtitle, align = 'center' }: any) => (
